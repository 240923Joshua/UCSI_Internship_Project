...
-- Dumping data for table internship.attendance: 18 rows
/*!40000 ALTER TABLE "attendance" DISABLE KEYS */;
INSERT INTO "attendance" ("attendance_id", "user_id", "internship_id", "date", "status") VALUES
	(64, 100001, 1, '2025-12-27', 'Present'),
	(65, 100001, 1, '2025-12-28', 'Present'),
	(66, 100001, 1, '2025-12-29', 'Absent'),
	(67, 100001, 1, '2025-12-30', 'Present'),
	(68, 100001, 1, '2025-12-31', 'Present'),
	(69, 100001, 1, '2026-01-06', 'Present'),
	(70, 100001, 1, '2025-12-16', 'Present'),
	(71, 100001, 1, '2025-12-17', 'Present'),
	(72, 100001, 1, '2025-12-18', 'Present'),
	(73, 100001, 1, '2025-12-19', 'Absent'),
	(74, 100001, 1, '2025-12-20', 'Present'),
	(75, 100001, 1, '2025-12-23', 'Present'),
	(76, 100001, 1, '2025-12-24', 'Present'),
	(77, 100001, 1, '2025-12-25', 'Absent'),
	(78, 100001, 1, '2025-12-26', 'Present'),
	(82, 100001, 1, '2026-01-01', 'Absent'),
	(83, 100001, 1, '2026-01-02', 'Present'),
	(84, 100001, 1, '2026-01-03', 'Present');
...
-- Dumping data for table internship.domain_skills: 6 rows
...
INSERT INTO "internship" ("internship_id", "user_id", "title", "domain", "weeks", "start_date", "end_date", "supervisor_id", "location_name", "location_type", "supervisor_title", "supervisor_department") VALUES
	(1, 100001, 'Backend Developer Intern', 'Backend Development', 12, '2025-12-16', '2026-03-16', 100004, 'UCSI University', 'On-site', NULL, NULL);
...
INSERT INTO "ml_results" ("result_id", "user_id", "internship_id", "predicted_score", "risk_level", "recommendation", "created_at") VALUES
	(6, 100001, 1, 78.0, 'Medium', 'Maintain consistency and improve task complexity', '2026-01-06 01:57:01');
...
INSERT INTO "user_details" ("user_id", "first_name", "last_name", "email", "phone_number", "department", "avatar_url") VALUES
	(100001, 'Jane', 'Doe', 'abc@exmaple.com', '1234567890', 'Computer Science', 'http://localhost:5000/static/avatars/avatar3.png'),
	...
	(100004, 'Test', 'Supervisor', 'test.supervisor@example.com', '987654321', NULL, 'http://localhost:5000/static/avatars/avatar2.png');
...
INSERT INTO "weekly_reports" ("report_id", "user_id", "internship_id", "week_number", "attendance_percentage", "task_description", "focus_skill", "skill_rating", "stress_level", "self_evaluation", "challenges", "next_week_priorities", "evidence_link", "submitted_at", "status", "supervisor_feedback", "reviewed_at") VALUES
	(1, 100001, 1, 1, 80, 'Implemented authentication system', 'Python', 8, 3, 'Good progress', 'Session handling', 'Improve validation', NULL, '2025-12-23 01:41:09', 'reviewed', 'Good start, focus on security', '2025-12-24 01:41:09'),
	(2, 100001, 1, 2, 80, 'Developed weekly report module', 'Flask', 8, 1, 'Steady improvement', 'Template logic', 'Add validations', NULL, '2025-12-30 01:41:09', 'reviewed', 'Well structured', '2025-12-31 01:41:09'),
	(3, 100001, 1, 3, 75, 'Integrated supervisor dashboard', 'SQL', 10, 1, 'Very confident', 'Complex joins', 'Optimize queries', NULL, '2026-01-04 01:41:09', 'reviewed', 'good ', '2026-01-06 02:54:13');
